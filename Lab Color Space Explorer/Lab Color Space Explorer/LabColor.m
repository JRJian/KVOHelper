...
+ (BOOL)automaticallyNotifiesObserversOfAComponent {
    return NO;
}

- (void)setAComponent:(double)aComponent {
    [self willChangeValueForKey:@"aComponent"];
    _aComponent = aComponent;
    [self didChangeValueForKey:@"aComponent"];
}
